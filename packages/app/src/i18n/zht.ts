...
export const dict = {
  ...
  "dialog.provider.alibabaCodingPlan.note": "阿里編碼套餐",
  "dialog.provider.deepseek.note": "DeepSeek 官方模型",
  "dialog.provider.moonshot.note": "Kimi 官方介面",
  "dialog.provider.zhipu.note": "智譜 GLM 系列模型",
  "dialog.provider.zhipuCodingPlan.note": "智譜編碼套餐",
  "dialog.provider.minimax.note": "MiniMax 官方模型",
  "dialog.provider.tencentCodingPlan.note": "騰訊編碼套餐",
  ...
  "dialog.model.unpaid.freeModels.title": "Aether 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Aether 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Aether 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Aether 伺服器。",
  ...
  "toast.session.export.started.title": "已發起下載",
  "toast.session.export.started.description": "已開始下載 {{files}}",
  "toast.session.export.failed.title": "匯出工作階段失敗",
  "toast.session.export.active.title": "工作階段仍在執行",
  "toast.session.export.active.description": "請等待目前回覆完成後再匯出此工作階段。",
  ...
  "toast.session.import.active.title": "專案中仍有工作階段正在執行",
  "toast.session.import.active.description": "請等待此專案中的所有工作階段完成後再匯入。",

  "toast.session.listFailed.title": "無法載入 {{project}} 的工作階段",

  "toast.update.title": "有可用更新",
  "toast.update.description": "Aether 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Aether 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Aether 暫不支援 MCP 認證。',
  ...
  "session.tab.gitGraph.author": "?",
  "session.tab.gitGraph.committer": "?",
  "session.tab.gitGraph.parents": "?",
  "session.tab.gitGraph.date": "?",
  "session.tab.gitGraph.fileChanges": "?",
  "session.tab.gitGraph.noFileChanges": "?",
  "session.tab.gitGraph.copyHash": "?",
  "session.tab.gitGraph.copyMessage": "?",
  "session.tab.gitGraph.checkout": "?",
  "session.tab.gitGraph.checkoutCommitTitle": "?",
  "session.tab.gitGraph.checkoutCommitDescription": "?",
  "session.tab.gitGraph.checkoutBranch": "?",
  "session.tab.gitGraph.createBranch": "?",
  "session.tab.gitGraph.mergeIntoCurrent": "?",
  "session.tab.gitGraph.rebaseCurrent": "?",
  "session.tab.gitGraph.resetToThis": "?",
  "session.tab.gitGraph.revertThis": "?",
  "session.tab.gitGraph.revertMergeTitle": "?",
  "session.tab.gitGraph.revertMergeDescription": "?",
  "session.tab.gitGraph.revertConfirmDescription": "?",
  "session.tab.gitGraph.cherryPick": "?",
  "session.tab.gitGraph.addTag": "?",
  "session.tab.gitGraph.binaryFile": "?",
  "session.tab.gitGraph.binaryFileDescription": "?",
  "session.tab.gitGraph.cherryPickTitle": "?",
  "session.tab.gitGraph.cherryPickParentDescription": "?",
  "session.tab.gitGraph.cherryPickRecordOrigin": "?",
  "session.tab.gitGraph.cherryPickRecordOriginDescription": "?",
  "session.tab.gitGraph.cherryPickNoCommit": "?",
  "session.tab.gitGraph.cherryPickNoCommitDescription": "?",
  "session.tab.gitGraph.resetDescription": "?",
  "session.tab.gitGraph.resetSoft": "?",
  "session.tab.gitGraph.resetMixed": "?",
  "session.tab.gitGraph.resetHard": "?",
  "session.tab.gitGraph.mergeTitle": "?",
  "session.tab.gitGraph.mergeDescription": "?",
  "session.tab.gitGraph.mergeNoFastForward": "?",
  "session.tab.gitGraph.mergeSquash": "?",
  "session.tab.gitGraph.mergeSquashDescription": "?",
  "session.tab.gitGraph.mergeNoCommit": "?",
  "session.tab.gitGraph.mergeNoCommitDescription": "?",
  "session.tab.gitGraph.rebaseTitle": "?",
  "session.tab.gitGraph.rebaseDescription": "?",
  "session.tab.gitGraph.rebaseIgnoreDate": "?",
  "session.tab.gitGraph.rebaseIgnoreDateDescription": "?",
  "session.tab.gitGraph.createBranchTitle": "?",
  "session.tab.gitGraph.createBranchName": "?",
  "session.tab.gitGraph.createBranchNamePlaceholder": "?",
  "session.tab.gitGraph.createBranchCheckout": "?",
  "session.tab.gitGraph.createBranchNameRequired": "?",
  "session.tab.gitGraph.addTagTitle": "?",
  "session.tab.gitGraph.addTagName": "?",
  "session.tab.gitGraph.addTagNamePlaceholder": "?",
  "session.tab.gitGraph.addTagNameRequired": "?",
  "session.tab.gitGraph.addTagType": "?",
  "session.tab.gitGraph.addTagTypeAnnotated": "?",
  "session.tab.gitGraph.addTagTypeLightweight": "?",
  "session.tab.gitGraph.addTagMessage": "?",
  "session.tab.gitGraph.addTagMessagePlaceholder": "?",
  ...
  "session.export.active.description": "工作階段執行期間無法匯出。",
  "session.export.warning.description": "此工作階段大小約為 {{size}}，匯出可能耗費較多時間和記憶體。是否繼續？",
  "session.export.progress.estimate": "正在估算備份大小...",
  "session.export.progress.fetch": "正在讀取工作階段...",
  "session.export.progress.build": "正在產生備份檔案...",
  "session.export.progress.download": "正在發起下載...",
  ...
  "sidebar.gettingStarted.line1": "Aether 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Aether 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Aether 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Aether 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Aether 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Aether 的主題。",
  ...
  "settings.general.row.branchGraphCompact.title": "對話樹視圖",
  "settings.general.row.branchGraphCompact.description": "選擇顯示完整內容還是簡略節點視圖",
  "settings.general.row.branchGraphCompact.option.full": "完整",
  "settings.general.row.branchGraphCompact.option.compact": "簡略",
  "settings.general.row.branchGraphOrderMode.title": "對話樹排序",
  "settings.general.row.branchGraphOrderMode.description": "選擇優先依訊息序列或時間排列節點",
  "settings.general.row.branchGraphOrderMode.option.sequence": "序列優先",
  "settings.general.row.branchGraphOrderMode.option.time": "時間優先",
  "settings.general.row.branchGraphDisplay.label": "顯示",
  "settings.general.row.branchGraphFontSize.title": "對話樹字型大小",
  "settings.general.row.branchGraphFontSize.description": "調整對話樹節點文字大小",
  "settings.general.row.branchGraphFontSize.option.xs": "特小",
  "settings.general.row.branchGraphFontSize.option.sm": "小",
  "settings.general.row.branchGraphFontSize.option.md": "標準",
  "settings.general.row.branchGraphFontSize.option.lg": "大",
  "settings.general.row.branchGraphFontSize.option.xl": "特大",
  "settings.general.row.branchGraphRowDensity.title": "對話樹行距",
  "settings.general.row.branchGraphRowDensity.description": "調整對話樹節點之間的垂直間距",
  "settings.general.row.branchGraphRowDensity.option.xcompact": "極緊湊",
  "settings.general.row.branchGraphRowDensity.option.compact": "緊湊",
  "settings.general.row.branchGraphRowDensity.option.normal": "標準",
  "settings.general.row.branchGraphRowDensity.option.relaxed": "寬鬆",
  ...
  "settings.updates.row.startup.description": "在 Aether 啟動時自動檢查更新",
  ...
  "session.import.warning.title": "大型工作階段備份",
  "session.import.warning.description": "此備份大小為 {{size}}，匯入可能耗費較多時間和記憶體。是否繼續？",
  "session.import.progress.title": "正在匯入工作階段",
  "session.import.progress.read": "正在讀取備份檔案...",
  "session.import.progress.parse": "正在解析並驗證備份...",
  "session.import.progress.import": "正在寫入工作階段資料...",
  "session.import.progress.refresh": "正在重新整理工作階段列表...",
  "workspace.new": "新增工作區",
  ...
  "workspace.delete.branch.title": "刪除分支",
  "workspace.delete.branch.confirm": '是否同時刪除分支 "{{branch}}"？',
  "workspace.delete.branch.keep": "保留分支",
  "workspace.delete.branch.delete": "刪除分支",
