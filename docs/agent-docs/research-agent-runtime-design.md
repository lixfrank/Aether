...
| 文档                                        | 视角       | 内容                                                                                                                                                                                                  |
| ------------------------------------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `research-agent-v2-overview.md`             | 实现架构   | 6层重构计划、核心源文件改动、验收清单、关键设计决策（命名、~~skill_refs 替换~~（已于 Layer 1.2 删除，见 `layer-1.2-skill-refs-removal.md`，回落正常 skill 机制 + prompt 软提示）、base_agent 取消等） |
